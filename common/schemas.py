...
class CalendarLabels(BaseModel):
    ...
    days_of_week: conlist(str, max_length=7, min_length=7) = ["Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс"] # type: ignore
    months: conlist(str, max_length=12, min_length=12) = [ # type: ignore
        "Янв", "Февр", "Мар", "Апр", "Май", "Июн", "Июл", "Авг", "Сент", "Окт", "Нояб", "Дек"
    ]
    cancel_caption: str = Field(default='Отмена', description='Отмена выбора дат')
    today_caption: str = Field(default='Сегодня', description='Сегоднешнее число')
